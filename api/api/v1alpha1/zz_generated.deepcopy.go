...
func (in *ConfigInfo) DeepCopyInto(out *ConfigInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigInfo.
func (in *ConfigInfo) DeepCopy() *ConfigInfo {
	if in == nil {
		return nil
	}
	out := new(ConfigInfo)
