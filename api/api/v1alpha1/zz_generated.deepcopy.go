...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomResState) DeepCopyInto(out *CustomResState) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomResState.
func (in *CustomResState) DeepCopy() *CustomResState {
	if in == nil {
		return nil
	}
	out := new(CustomResState)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ManifestSpec) DeepCopyInto(out *ManifestSpec) {
	*out = *in
	...
	if in.CustomResStates != nil {
		in, out := &in.CustomResStates, &out.CustomResStates
		*out = make([]CustomResState, len(*in))
		copy(*out, *in)
	}
}
