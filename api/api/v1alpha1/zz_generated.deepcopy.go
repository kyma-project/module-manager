...
func (in *InstallInfo) DeepCopyInto(out *InstallInfo) {
	*out = *in
	...
	out.OverrideRef = in.OverrideRef
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OverrideInfo) DeepCopyInto(out *OverrideInfo) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OverrideInfo.
func (in *OverrideInfo) DeepCopy() *OverrideInfo {
	if in == nil {
		return nil
	}
	out := new(OverrideInfo)
	in.DeepCopyInto(out)
	return out
}
